...
-   **[Сервис Чата](https://github.com/Kovalyovv/chat-app/blob/kova-chat-proto-wt-prsnt-msg-dlvr-trkng/README.md):** Сервис для обмена сообщениями в реальном времени через WebSocket, который использует `auth-service` для аутентификации пользователей.
-   **[Обработчик Медиа](https://github.com/Kovalyovv/media-processor/blob/master/README.md):** Асинхронный сервис для обработки загруженных файлов, который также использует `auth-service` для проверки прав доступа пользователей.
